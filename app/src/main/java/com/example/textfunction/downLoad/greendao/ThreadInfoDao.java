package com.example.textfunction.downLoad.greendao;
...
public class ThreadInfoDao extends AbstractDao<ThreadInfo, Long> {
    ...
    public static class Properties {
        ...
        public final static Property FileLength = new Property(2, long.class, "fileLength", false, "FILE_LENGTH");
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"THREAD_INFO\" (" + //
                ...
                "\"URL\" TEXT," + // 1: url
                "\"FILE_LENGTH\" INTEGER NOT NULL ," + // 2: fileLength
